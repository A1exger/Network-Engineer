...
#### DHCPv6 настроил, но не было ни слова про 4-ю версию...это было странно да. После расследования и поиска зацепок была обнаружена отдельным файлом лабораторная по настройке DHCPv4. Продолжение следует дальше.
# Реализация DHCPv4
####
