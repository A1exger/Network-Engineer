...
#### Почему протокол spanning-tree выбрал этот порт в качестве невыделенного (заблокированного) порта? *Все критерии совпадают, кроме стоимости. Здесь наименьшая стоимость и к тому же порт не смотрит в сторону Root-коммутатора.Поэтому выбран этот порт*
